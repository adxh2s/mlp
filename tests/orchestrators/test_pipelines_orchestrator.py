...
def _cfg_like_pydantic(pipeline, active=None, cv=None, policy=None, enabled=True):
    # Simule PipelineConfig Pydantic minimal avec model_dump sur les items
    def _wrap(spec):
    ...
    return SimpleNamespace(
        ...
        pipeline=[_wrap(p) for p in pipeline],
    )
